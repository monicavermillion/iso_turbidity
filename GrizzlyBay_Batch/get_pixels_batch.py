...
config_isofit ={
    "ISOFIT_base": "../../..",
      ...
      "input": {"measured_radiance_file": "../remote/prm20140428t230950.txt"},
...
for i,j in enumerate(lines):
    t_line = int(lines[i]) # Test line
    t_sample = int(samples[i]) # Test sample
    print(t_line,t_sample)
    ...
    bash_name = 'bash_scrips/run_'+base_name+'.sh' # name of bash script file
